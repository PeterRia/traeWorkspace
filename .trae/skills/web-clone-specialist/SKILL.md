...
description: "Transforms URLs, screenshots, and Figma designs into high-fidelity frontend code. Invoke when user wants to clone/replicate a webpage, restore a design, or convert a URL/screenshot to code."
---

# Web Clone Specialist
